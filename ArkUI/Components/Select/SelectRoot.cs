...
public class SelectRoot<TValue> : ComponentBase, IAsyncDisposable where TValue : notnull
{
    /// <summary>
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        builder.AddComponentParameter(3, "ChildContent", (RenderFragment)(childBuilder =>
        {
            ...
            if (!string.IsNullOrEmpty(Name))
            {
                ...
                childBuilder.AddAttribute(2, "type", "hidden");
                childBuilder.AddAttribute(3, "name", Name);
                childBuilder.AddAttribute(4, "value", EffectiveValueAsString);
