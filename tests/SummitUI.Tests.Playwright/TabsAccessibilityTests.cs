...
public class TabsAccessibilityTests : PageTest
{
    ...
    {
        var tabsList = Page.Locator("[data-summit-tabs-list]").First;
    ...
    {
        var trigger = Page.Locator("[data-summit-tabs-trigger]").First;
    ...
    {
        var activeTrigger = Page.Locator("[data-summit-tabs-trigger][data-state='active']").First;
    ...
    {
        var inactiveTrigger = Page.Locator("[data-summit-tabs-trigger][data-state='inactive']").First;
    ...
    public async Task Trigger_ShouldHave_DataStateInactive_WhenNotSelected()
    {
        ...
        var trigger = Page.Locator("[data-summit-tabs-trigger]").Nth(1);
    ...
    {
        var content = Page.Locator("[data-summit-tabs-content]").First;
    ...
    {
        var contents = Page.Locator("[data-summit-tabs-content]");
    ...
    {
        var content = Page.Locator("[data-summit-tabs-content][data-state='active']").First;
    ...
    {
        var disabledTrigger = Page.Locator("[data-summit-tabs-trigger][data-disabled]").First;
    ...
    {
        var disabledTrigger = Page.Locator("[data-summit-tabs-trigger][data-disabled]");
    ...
    public async Task DisabledTrigger_ShouldNotActivate_OnClick()
    {
        ...
        var disabledContent = Page.Locator($"[data-summit-tabs-content][data-state='active']");
    ...
    public async Task Click_ShouldActivateTab()
    {
        ...
        var passwordTrigger = Page.Locator("[data-summit-tabs-trigger][data-value='password']");
    ...
    public async Task Click_ShouldShowCorrespondingContent()
    {
        ...
        var passwordContent = Page.Locator("[data-summit-tabs-content][data-state='active']");
    ...
    public async Task Click_ShouldDeactivatePreviousTab()
    {
        ...
        var accountTrigger = Page.Locator("[data-summit-tabs-trigger][data-value='account']");
    ...
    public async Task Tab_ShouldFocusActiveTabTrigger_FromOutside()
    {
        ...
        var activeTrigger = Page.Locator("[data-summit-tabs-trigger][data-state='active']");
    ...
    public async Task Tab_ShouldMoveFocusToContent_AfterTrigger()
    {
        ...
        var activeContent = Page.Locator("[data-summit-tabs-content][data-state='active']");
    ...
    public async Task OnlyActiveContent_ShouldBeVisible()
    {
        ...
        var allContents = Page.Locator("[data-summit-tabs-content]");
    ...
    public async Task ContentVisibility_ShouldUpdate_OnTabChange()
    {
        ...
        var accountContent = Page.Locator("[data-summit-tabs-content][aria-labelledby*='account']");
        ...
        var passwordContent = Page.Locator("[data-summit-tabs-content][aria-labelledby*='password']");
    ...
    public async Task AllEnabledTriggers_ShouldHave_ValidAriaControls_WhenActive()
    {
        ...
        var triggers = Page.Locator("[data-summit-tabs-trigger]:not([data-disabled])");
        var count = await triggers.CountAsync();
        ...
        for (var i = 0; i < count; i++)
        {
            ...
            var referencedContent = Page.Locator($"[data-summit-tabs-content][id='{ariaControls}']");
