...
/// </summary>
public partial class SuCardTitle : ComponentBase
{
    /// <summary>
    /// The content to render inside the card title.
    /// </summary>
    ...
    private const string BaseClasses = "text-lg font-semibold leading-none tracking-tight";
