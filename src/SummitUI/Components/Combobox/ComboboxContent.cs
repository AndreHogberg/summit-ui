...
public class ComboboxContent<TValue> : ComponentBase, IAsyncDisposable where TValue : notnull
{
    [Inject]
    ...
    private DotNetObjectReference<ComboboxContent<TValue>>? _dotNetRef;
