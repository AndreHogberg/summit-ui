...
/// </summary>
public partial class SmScrollAreaRoot : ComponentBase, IAsyncDisposable
{
    private void RenderContent(RenderTreeBuilder builder)
    {
        builder.OpenElement(0, As);
        builder.AddAttribute(1, "data-summit-scroll-area-root", "true");
        builder.AddAttribute(2, "dir", _context.Dir);
        builder.AddAttribute(3, "style", CombinedStyle);
        builder.AddMultipleAttributes(4, AdditionalAttributes);
        builder.OpenComponent<CascadingValue<ScrollAreaContext>>(5);
        builder.AddComponentParameter(6, "Value", _context);
        builder.AddComponentParameter(7, "IsFixed", false);
    ...
    private DotNetObjectReference<SmScrollAreaRoot>? _dotNetRef;
