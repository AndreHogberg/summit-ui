...
/// </code>
/// </example>
public partial class SmToast<TContent> : ComponentBase, IAsyncDisposable
{
    [Inject]
    ...
    private DotNetObjectReference<SmToast<TContent>>? _dotNetRef;
    private bool _swipeRegistered;

    private string AriaLive => Urgency == ToastUrgency.Assertive ? "assertive" : "polite";
