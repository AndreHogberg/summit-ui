...
/// </summary>
public class DropdownMenuSubTrigger : ComponentBase, IDisposable, IAsyncDisposable
{
    [Inject]
    ...
    private DotNetObjectReference<DropdownMenuSubTrigger>? _dotNetRef;
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        builder.AddAttribute(4, "aria-expanded", IsOpen ? "true" : "false");
        builder.AddAttribute(5, "aria-controls", IsOpen ? SubContext.SubMenuId : null);
        builder.AddAttribute(6, "tabindex", "-1");
        if (Disabled)
        {
            builder.AddAttribute(7, "aria-disabled", "true");
        }
        builder.AddAttribute(8, "data-summit-dropdown-menu-sub-trigger", "");
        ...
        if (IsHighlighted)
        {
            builder.AddAttribute(11, "data-highlighted", "");
        }
        builder.AddAttribute(12, "onclick", EventCallback.Factory.Create<MouseEventArgs>(this, HandleClickAsync));
        builder.AddAttribute(13, "onpointerenter", EventCallback.Factory.Create<PointerEventArgs>(this, HandlePointerEnterAsync));
        builder.AddAttribute(14, "onpointerleave", EventCallback.Factory.Create<PointerEventArgs>(this, HandlePointerLeaveAsync));
        builder.AddAttribute(15, "onpointermove", EventCallback.Factory.Create<PointerEventArgs>(this, HandlePointerMoveAsync));
        builder.AddAttribute(16, "onkeydown", EventCallback.Factory.Create<KeyboardEventArgs>(this, HandleKeyDownAsync));
        builder.AddEventPreventDefaultAttribute(17, "onkeydown", true);
        builder.AddEventStopPropagationAttribute(18, "onkeydown", true);
        builder.AddMultipleAttributes(19, AdditionalAttributes);
        builder.AddElementReferenceCapture(20, (elementRef) => { _elementRef = elementRef; });
