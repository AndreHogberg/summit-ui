...
public partial class SmSelectTrigger<TValue> : ComponentBase, IAsyncDisposable where TValue : notnull
{
    private void RenderContent(RenderTreeBuilder builder)
    {
        ...
        builder.AddAttribute(10, "aria-required", Context.Required ? "true" : null);
        builder.AddAttribute(11, "aria-invalid", Context.Invalid ? "true" : null);
        builder.AddAttribute(12, "aria-disabled", Context.Disabled ? "true" : null);
        builder.AddAttribute(13, "disabled", Context.Disabled ? true : null);
        builder.AddAttribute(14, "data-state", DataState);
        builder.AddAttribute(15, "data-disabled", Context.Disabled ? "" : null);
        builder.AddAttribute(16, "data-invalid", Context.Invalid ? "" : null);
        builder.AddAttribute(17, "data-placeholder", Context.Value is null ? "" : null);
        ...
        builder.AddElementReferenceCapture(21, elemRef => _elementRef = elemRef);
