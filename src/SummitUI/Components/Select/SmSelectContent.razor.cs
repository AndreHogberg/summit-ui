...
public partial class SmSelectContent<TValue> : ComponentBase, IAsyncDisposable where TValue : notnull
{
    ...
    private DotNetObjectReference<SmSelectContent<TValue>>? _dotNetRef;
